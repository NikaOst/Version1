      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <p className="font-sansroboto text-primary/90 text-md text-justify leading-relaxed">
              Bei Sernitas Care stehen die Menschen im Mittelpunkt. Mit Herz, Respekt und echter
              Hingabe kümmern wir uns um das Wohl unserer Klientinnen und Klienten. Für uns ist
              Pflege mehr als nur ein Beruf – es ist eine Herzensangelegenheit. Denn wahre Fürsorge
          ...
          <p className="mt-4 text-primary/90 text-lg italic font-bold">Sümeyya Yildiz</p>
