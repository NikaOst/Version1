      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <p className="font-sansroboto text-primary/90 text-md xl:text-lg text-justify leading-relaxed italic pb-4">
              Der respektvolle und vertrauensvolle Umgang mit Menschen gehört zu den elementaren
              Bestandteilen unseres Handelns und spiegelt sich auch in unserem Namen wieder.
              Zusammengesetzt aus den lateinischen Begriffen Servitium (= Dienstleistung) und
              Humanitas (= Menschlichkeit) beschreibt er den Kern unseres Handelns: den Dienst am
              Menschen.
            </p>
