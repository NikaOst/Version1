      ...
      <div className="container flex flex-col md:flex-row items-center justify-center gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          <p className="font-sansroboto text-primary/90 text-md xl:text-lg text-justify leading-relaxed italic pb-4">
            „Sernitas ist mein Begleiter am Morgen, am Mittag und am Abend. Dank Sernitas Care kann
            ich, trotz meines hohen Alters, selbstbestimmt und zufrieden zuhause wohnen und leben.“
          </p>
          <p className="font-serif text-primary/90 text-2xl font-bold tracking-wide">Frau Müller</p>
