      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          <p className="font-sansroboto text-primary/90 text-md xl:text-lg text-justify leading-relaxed italic pb-4">
            „Pflege zu Hause schenkt uns jeden Tag ein bisschen Lebensfreude. Die Betreuer
            respektieren unsere individuellen Bedürfnisse und helfen uns unseren Alltag weiterhin
            flexibel zu gestalten.“
          </p>
          <p className="font-serif text-primary/90 text-2xl font-bold tracking-wide">Fam. Zipple</p>
