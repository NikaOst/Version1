...
const Aktuelles = () => {
  const newsData = [
    ...
    },
    {
      ...
      hashtags: '#almanya #almanca #sernitasgroup #almanyaiş #hemşire #sernitascare',
  ...
  return (
    <div className="py-12 xl:py-24 px-6 lg:px-12 xl:px-44 space-y-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-primary/90 text-justify">
          Bei Sernitas Care bleiben Sie auf dem neuesten Stand rund um die Themen Pflege,
          Gesundheitspolitik und Fachkräfteentwicklung. Auf dieser Seite finden Sie aktuelle
          Nachrichten, Fachbeiträge, Blogartikel, Pressemeldungen sowie spannende Einblicke in
          unsere tägliche Arbeit.
        </p>
        <p className="text-primary/90 text-justify">
          Unsere Beiträge informieren nicht nur über gesetzliche Neuerungen und Pflegestandards,
          sondern werfen auch einen Blick über den Tellerrand – etwa auf internationale
          Fachkräftegewinnung, Digitalisierung im Gesundheitswesen oder Innovationen in der Pflege.
        </p>
      </div>
      ...
      <div className="text-center space-y-6 py-12">
        ...
        <p className="text-primary/90">
          Ob auf LinkedIn, Instagram oder Facebook – unsere Kanäle geben Ihnen einen persönlichen
          Einblick in unseren Alltag, aktuelle Stellenausschreibungen, Erfolgsgeschichten aus dem
          Pflegebereich und Neuigkeiten aus unseren internationalen Kooperationen.
          <br />
          <br />
          Treten Sie in den Dialog mit uns, teilen Sie Ihre Meinung oder erfahren Sie als Erste*r
          von offenen Stellen und Projekten.
        </p>
      </div>
        ...
        {newsData.map((news) => (
          <a
            ...
            <div className="relative">
              <CachedImage src={news.image} alt="News" className="w-full h-72 object-cover" />
