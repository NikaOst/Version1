...
import { FaFacebook, FaInstagram, FaTwitter, FaYoutube, FaLinkedin, FaXing } from 'react-icons/fa';
      ...
      <footer className="bg-primary/90 text-white py-12">
        <motion.div
          ...
          <motion.div
            ...
            <CachedImage src={Logo} alt="Sernitas Logo" className="w-[200px] mx-auto md:mx-0" />
            <p className="font-sansroboto text-lg">Wir globalisieren die Gesundheit!</p>
            <p className="font-sansroboto text-lg font-medium">Folgen Sie uns</p>
        ...
        <motion.div
          ...
          <p className="font-sansroboto text-md">
            Made with <span className="text-red-500">❤️</span>
          </p>
          <p className="text-sm font-medium">COPYRIGHT &copy; 2025 Sernitas GmbH</p>
        </motion.div>
      </footer>
