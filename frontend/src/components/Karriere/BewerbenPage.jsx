  ...
  return (
    <div className="containero">
      ...
      <div className="py-24 px-6 lg:px-12 xl:px-44  grid md:grid-cols-2 gap-12">
        ...
        {/* Right Section - Form */}
        <div>
          <h2 className="font-sansroboto text-primary/90 text-2xl xl:text-3xl font-bold mb-12">
          ...
          <p className="mb-12 text-primary/90">
            ...
            von Ihnen zu hören. Unsere Experten melden sich innerhalb kürzester Zeit bei Ihnen.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className=" space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="text-primary/90 ">
                <label className="text-primary/90 block mb-1">Geschlecht *</label>
                <select {...register('gender')} className="home-consultation-input">
              ...
              <div>
                <label className="text-primary/90 block mb-1">Abschluss *</label>
                <select {...register('degree')} className="home-consultation-input">
                  <option value="">Bitte auswählen</option>
              ...
              <div>
                <label className="text-primary/90 block mb-1">Unternehmen *</label>
                <input
                  {...register('company')}
                  className="home-consultation-input"
              ...
              <div>
                <label className="text-primary/90 block mb-1">Aufenthaltsland *</label>
                <input
                  {...register('country')}
                  className="home-consultation-input"
              ...
              <div>
                <label className="text-primary/90 block mb-1">Telefonnummer *</label>
                <input
                  {...register('phone')}
              ...
              <div>
                <label className="text-primary/90 block mb-1">LinkedIn Profil *</label>
                <input
                  {...register('linkedin')}
                  className="home-consultation-input"
            ...
            <div>
              <label className="text-primary/90 block mb-1">Betreffzeile *</label>
              <input
                {...register('subject')}
                className="input home-consultation-input"
