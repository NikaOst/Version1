    ...
    <div className="bg-gray-50">
      ...
      <section className="py-12 xl:py-24 px-6 lg:px-12 xl:32  bg-slate-100">
        <div className="max-w-6xl mx-auto text-center space-y-6">
          <h2 className="font-sansroboto text-secondary text-xl font-medium mb-4 ">
            EIN TEAM VON EXPERTEN
          </h2>
          <h1 className="font-sansroboto text-primary/90 text-3xl lg:text-4xl font-bold mb-16">
          ...
          <div className="max-w-full mx-auto flex flex-col md:flex-row items-center gap-10 text-primary/90 text-justify space-y-16">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="font-sansroboto text-3xl font-bold mt-12 mb-6">Unsere Arbeitsweise</h2>
              <p className="text-base md:text-lg leading-relaxed mb-4">
                In unserem Unternehmen stehen unsere Kund:innen und Mitarbeiter:innen im
                Mittelpunkt. Ganz gleich, welchen Beruf Sie ausüben, ohne unsere Mitarbeiter:innen
                können wir den hohen Qualitätsstandard unserer Unternehmen nicht gewährleisten.
              </p>
              <p className="text-base md:text-lg leading-relaxed">
                Das Unternehmen Sernitas GmbH benötigt stets engagierte und gut ausgebildete
                Teamkolleg:innen. Wir wissen, dass hohe Qualitätsleistungen und kompetentes Personal
                die Grundlage für Erfolg sind. Dieser Grundsatz ist uns wichtig und ein Anliegen.
                Wenn Du genauso denkst und dich angesprochen fühlst und in einer freundlichen,
                internationalen Atmosphäre arbeiten möchtest, freuen wir uns auf Deine Bewerbung.
              </p>
            </div>
      ...
      <section className="py-24 px-6 lg:px-12 xl:px-32">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-sansroboto text-primary/90 text-4xl font-bold text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center text-center">
            {jobPosts.map((job, index) => (
              <a
                ...
                <h3 className="text-secondary text-xl font-bold mb-2">{job.title}</h3>
      ...
      <section className="py-24 px-6 lg:px-12 xl:px-32 text-center">
        <h2 className="font-sansroboto text-primary/90 text-xl lg:text-2xl font-medium mb-16">
          Haben wir Dein Interesse geweckt? Dann bewirb dich gleich! Wir freuen uns dich
          kennenzulernen.
        </h2>
        <a
          href="/karriere/bewerben"
