            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center justify-center">
                  ...
                  {info.map((item, index) => (
                    <li key={index} className="flex items-center gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="text-xl text-primary/90">{item.description}</h3>
                      </div>
                    </li>
                  ))}
                </ul>
              ...
              <motion.div
                ...
                <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                  <h2 className="font-sansroboto text-2xl lg:text-3xl text-white/90">
                    Wir sind für Sie da
                  </h2>
                  <p className="text-white/80 text-justify">
                    Treten Sie mit Sernitas Care in Kontakt – wir stehen Ihnen mit vertrauensvoller,
                    einfühlsamer und professioneller Pflege zur Seite. Gemeinsam sorgen wir für mehr
                    Wohlbefinden, Würde und Geborgenheit für Ihre Liebsten. Wir freuen uns auf Ihre
                    Nachricht!
                  </p>
